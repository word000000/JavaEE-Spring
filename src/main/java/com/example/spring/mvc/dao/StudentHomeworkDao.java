...
public interface StudentHomeworkDao extends JpaRepository<StudentHomework,Long> {
    ...
    public int addStudentHomework (@Param("id")long id,
                              @Param("sid")long studentId,
                              @Param("hid")long homeworkId,
                              @Param("title")String homeworkTitle,
                              @Param("content")String homeworkContent,
                              @Param("time")Timestamp createTime);
